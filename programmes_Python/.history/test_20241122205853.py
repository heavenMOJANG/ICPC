...
fromAddress = "18952976105@163.com"
toAddress = "934728143@qq.com"
# 发送方，验证信息，由于邮箱输入信息会使用base64编码，因此需要进行编码
username = "MTg5NTI5NzYxMDVAMTYzLmNvbQ=="  # 输入自己的用户名对应的编码
password = "MRs2V36vWvRCtVKK"  # 此处不是自己的密码，而是开启SMTP服务时对应的授权码
