...
ll a,b,n,g[1010][1010],ymin[1010][1010],ymax[1010][1010],xmax[1010][1010],xmin[1010][1010],minn=LLONG_MAX;
...
void solve(){
    ...
    for(ll i=1;i<=a-n+1;++i)
		for(ll j=1;j<=b-n+1;++j) minn=min(minn,xmax[i][j]-xmin[i][j]);
    cout<<minn;
    return;
}
